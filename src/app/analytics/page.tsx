    ...
    <div className="max-w-[1600px] mx-auto">
      ...
      <KPIRibbon
        kpis={[
          ...
          {
            label: "Core Question",
            value: "Where is pressure rising?",
            color: "blue",
          },
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-8">
          <GICCard
            premium
            title="Pressure Trend and Domain Exposure"
            subtitle="Which services are creating the most operational pressure?"
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-8">
          <GICCard
            ...
            subtitle="Which municipalities need intervention first?"
          ...
          <GICCard
            ...
            subtitle="How strong is the underlying evidence mix?"
            icon={<PieChart className="w-5 h-5 text-gic-blue" />}
          >
