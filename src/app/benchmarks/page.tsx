  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <GICCard
          premium
          title="GIC vs Regional Peers"
          subtitle="Efficiency Score Audit"
            ...
            {[
              ...
              <div key={i} className="space-y-3">
                <div className="flex justify-between items-center">
                  <span
                    className={`text-[10px] font-black uppercase tracking-widest ${peer.isMain ? "text-slate-900" : "text-slate-400"}`}
                  >
                    {peer.name}
                  </span>
                ...
                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                  <div
                    className={`h-full ${peer.isMain ? "bg-gic-dark shadow-gic-glow" : "bg-slate-300"}`}
