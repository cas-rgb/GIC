      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[10px] font-black text-red-500 uppercase tracking-[0.4em]">
              Live Environment / Risk Vectors
            </span>
          </div>
          <h1 className="text-5xl font-display font-bold text-white tracking-tighter uppercase leading-none">
            Operational Risk
          </h1>
        </div>
        ...
        <div className="flex items-center gap-10">
          <div className="text-right">
            <p className="text-[9px] font-black text-slate-700 uppercase tracking-[0.3em] mb-1">
              Integrity Status
            </p>
            <div className="flex items-center gap-4 justify-end">
              <div className="w-2 h-2 rounded-full bg-blue-500 shadow-gic-glow animate-pulse" />
              <span className="text-2xl font-display font-bold text-white tracking-tight uppercase">
                Nominal
              </span>
            </div>
          </div>
        ...
        >
          <div className="gic-glass-premium h-[500px] rounded-[3rem] overflow-hidden relative group border border-white/[0.08] shadow-gic-neon p-1">
            ...
            <div className="relative z-10 text-center">
              ...
              <h3 className="text-3xl font-display font-bold text-white/40 uppercase tracking-[0.4em]">
                Tactical Overlay Active
              </h3>
              <div className="mt-8 flex gap-4 justify-center">
                <span className="px-6 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-[10px] font-black text-blue-500 uppercase tracking-widest">
                  Gauteng North
                </span>
                <span className="px-6 py-2 bg-red-500/10 border border-red-500/20 rounded-full text-[10px] font-black text-red-500 uppercase tracking-widest">
                  2 Alert Zones
                </span>
              </div>
            </div>
        ...
        >
          <div className="gic-glass-premium p-12 rounded-[4rem] border border-white/[0.06] bg-red-500/[0.02]">
            ...
            <div className="space-y-8">
              {[
                {
                  title: "Structural Instability - Sector 4",
                  level: "Critical",
                  time: "4m ago",
                },
                {
                  title: "Encroachment Detected - Zone B",
                  level: "High",
                  time: "18m ago",
                },
              ].map((alert, i) => (
                <div
                  key={i}
                  className="p-8 bg-red-500/[0.03] border border-red-500/10 rounded-[2.5rem] hover:bg-red-500/10 transition-all duration-700 border-l-2 border-l-red-500"
                >
                  <p className="text-[15px] font-bold text-white mb-4 tracking-tight leading-snug">
                    {alert.title}
                  </p>
          ...
          <div className="gic-glass-premium p-12 rounded-[4rem] border border-white/[0.06] flex-1">
            ...
            <div className="space-y-10">
              {(["Structural", "Civil", "Roads", "Health"] as const).map(
                (sector) => (
