    ...
    <div className="">
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
          <GICCard
            premium
            title="Command Brief: Regional Resilience"
            subtitle="System-Generated Strategic Narrative"
            icon={<Zap className="w-5 h-5 text-gic-blue" />}
          >
            <div className="p-8 bg-slate-900 text-white rounded-[3rem] shadow-gic-hard relative overflow-hidden mb-8">
              ...
              <div className="relative z-10 space-y-6">
                <h4 className="text-2xl font-display font-bold text-white tracking-tight uppercase">
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-8">
          <GICCard
            ...
            subtitle="National Resilience Index"
            icon={<Target className="w-5 h-5 text-gic-gold" />}
          >
            <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
              ...
              <div className="text-center">
                <p className="text-5xl font-display font-black text-slate-900 mb-2">
          ...
          <GICCard
            title="Advanced Data Command"
            subtitle="Institutional BI Linkage"
            icon={<BarChart3 className="w-5 h-5 text-gic-blue" />}
          >
            <div className="space-y-6">
              <p className="text-[10px] font-medium text-slate-500 leading-relaxed">
                Connect real-time Firestore pipelines to Looker Studio for
                multidimensional institutional analysis and PDF reporting.
              </p>
              ...
              <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[10px] font-bold text-slate-900">
                    {boardroom.totalProjects} Linked
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[9px] font-black uppercase text-slate-400">
              ...
              <button
                onClick={() =>
                  window.open(
                    "file:///C:/Users/Dell/.gemini/antigravity/brain/fe209c20-889f-4813-aaa0-f2cc69a75239/looker_studio_guide.md",
                    "_blank",
                  )
                }
          ...
          >
            <div className="p-10 text-center">
              ...
              <h4 className="text-4xl font-display font-bold text-slate-900 tracking-tighter uppercase">
                Apex
              </h4>
