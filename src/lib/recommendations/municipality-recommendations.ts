...
function getMunicipalityOwnerOffice(
  issue: string,
  ...
  return topLeader
    ...
    : "Municipal Service Delivery War Room";
}
...
export async function getMunicipalityRecommendations(
  ...
  const recommendations: ProvinceRecommendation[] = [
    {
      ...
      evidenceCount:
        ...
        publicVoice.summary.totalCitizenMentions,
      officialShare,
    ...
    },
    {
      ...
      urgency:
        ...
        publicVoice.summary.narrativeRiskLevel === "High"
          ? "High"
          : "Medium",
      impactTier: getImpactTier(
        Number(
          (
            Math.max(
              ...
              publicVoice.summary.averageNegativeShare,
              0.2,
            ) *
              0.5 +
      ...
      ownerOffice: topLeader
        ? "Office of the Executive Mayor"
        : "Municipal Communications and Response Coordination",
      evidenceCount:
  ...
  if (
    publicVoice.summary.totalCitizenMentions >= 6 &&
    publicVoice.summary.narrativeRiskLevel !== "Low"
  ) {
