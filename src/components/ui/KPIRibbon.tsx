      ...
      {kpis.map((kpi, i) => {
        ...
        return (
          ...
          >
            {/* Status Glow */}
            <div
              className={`absolute top-0 right-0 w-32 h-32 blur-[45px] opacity-10 group-hover:opacity-20 transition-opacity ${
                kpi.color === "blue"
                  ? "bg-gic-blue"
                  : kpi.color === "gold"
                    ? "bg-gic-gold"
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex justify-between items-start mb-auto">
                ...
                {kpi.trend && (
                  <div
                    className={`flex items-center gap-1.5 px-2 py-0.5 rounded-lg text-[9px] font-black uppercase tracking-widest ${
                      kpi.trajectory === "up"
                        ? "text-emerald-500"
                        : kpi.trajectory === "down"
                          ? "text-rose-500"
