...
export default function GICAnalytics({
  type,
  data,
  labels,
  color = "blue",
  ...
  const colorClasses = {
    blue: {
      ...
      shadow: "0 0 20px rgba(0, 209, 255, 0.5)",
    },
    gold: {
      stroke: "#fbb600",
      fill: "rgba(251, 182, 0, 0.1)",
      shadow: "0 0 20px rgba(251, 182, 0, 0.5)",
    },
    emerald: {
      stroke: "#10b981",
    ...
    rose: {
      ...
      shadow: "0 0 20px rgba(244, 63, 94, 0.5)",
    },
  };
  ...
  return (
    <div
      className={`gic-analytics-container relative ${className}`}
      style={{ height }}
    >
      {renderVisual()}
