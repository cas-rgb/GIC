...
export function LoadingState({ message = "Retrieving Intelligence..." }) {
    return (
        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.5em]">{message}</p>
        </div>
    );
}

export function EmptyState({ title = "No Intelligence Gathered", subtitle = "System is ready for ingestion." }) {
    return (
        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6 grayscale opacity-40">
            ...
            <div>
                <h4 className="text-lg font-display font-bold text-slate-900 uppercase tracking-tight">{title}</h4>
...
export function ErrorState({ message = "Security Protocol Interrupted Connection" }) {
    return (
        <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div>
                <h4 className="text-lg font-display font-bold text-slate-900 uppercase tracking-tight">System Fault</h4>
