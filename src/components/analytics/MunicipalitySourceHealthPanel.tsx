...
interface MunicipalitySourceHealthPanelProps {
  province: string;
  municipality: string;
}
...
export default function MunicipalitySourceHealthPanel({
  province,
  municipality,
}: MunicipalitySourceHealthPanelProps) {
        ...
        setState({
          ...
          message:
            error instanceof Error
              ? error.message
              : "Failed to load municipality source health",
        });
      }
    }
    ...
    return (
      <div className="flex min-h-[180px] items-center justify-center">
        <div className="flex items-center gap-3 text-sm font-bold text-slate-400">
          ...
          Loading province source health...
        </div>
      </div>
    );
  }
