      ...
      <div className="flex justify-between items-center mb-10 pb-4 border-b border-gray-100">
        <div>
          ...
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
            Success-Case Mirroring & ROI Analysis
          </p>
        </div>
      ...
      <div className="flex-1 space-y-8">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
          <div className="px-8 py-4 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
            ...
            <div className="px-2 py-0.5 bg-emerald-50 text-emerald-600 border border-emerald-100 text-[8px] font-black rounded uppercase">
              94% Confidence
            </div>
          </div>
          <div className="p-8">
            <div className="text-3xl font-black text-gray-900 mb-6 italic tracking-tight">
              "{data.matchedCase}"
            </div>
