    ...
    <div className="bg-white rounded-[2.5rem] border border-slate-200 p-8 h-full flex flex-col shadow-gic-professional overflow-hidden relative">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl">
          ...
          <span className="text-[8px] font-black text-slate-400 uppercase ml-2">
            Total Points
          </span>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className={`p-2 rounded-xl text-white ${COLOR_MAP[source] || "bg-slate-400"} shadow-lg group-hover:scale-110 transition-transform`}
                >
