          ...
          <div className="space-y-6">
            <div className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[10px] font-black text-gic-gold uppercase tracking-widest">
                  Sector Peak
                </span>
              </div>
              <p className="text-sm font-bold leading-relaxed">
                Logistics Hub confidence is at a 5-year high due to corridor
                upgrades.
              </p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 transition-colors">
              ...
              <p className="text-sm font-bold leading-relaxed">
                PPP pipeline in Energy sector showing R4.2B in potential
                commitments.
              </p>
            </div>
          </div>
