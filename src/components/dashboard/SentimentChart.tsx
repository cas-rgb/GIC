    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm font-sans h-full flex flex-col">
            <div className="flex justify-between items-center mb-10">
                <div>
                    <h3 className="text-xl font-black text-gray-900 tracking-tight uppercase">Public Sentiment Audit</h3>
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Multi-Channel Perception Map</p>
                </div>
                <div className="px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl">
                    <span className="text-lg font-black text-gray-900">{total}</span>
                    <span className="text-[8px] font-black text-gray-400 uppercase ml-2">Total Signals</span>
                </div>
            </div>
            ...
            <div className="flex-1 space-y-8">
                <div className="space-y-3">
                    <div className="flex justify-between items-end">
                        <span className="text-[10px] font-black text-green-600 uppercase tracking-widest">Positive Resilience</span>
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-end">
                        <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">Neutral Stability</span>
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-end">
                        <span className="text-[10px] font-black text-red-500 uppercase tracking-widest">Negative Vulnerability</span>
