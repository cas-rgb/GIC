...
export interface NewsArticle extends BaseEntity {
    ...
    categories: Category[];
    narrativeTheme?: 'Service Delivery Crisis' | 'Government Accountability' | 'Community Activism' | 'Infrastructure Investment' | 'Urban Expansion'; // From Category 10
...
export interface FundingPartner extends BaseEntity {
    name: string;
    type: 'NGO' | 'Private Equity' | 'Development Bank' | 'Corporate Social Investment';
